...
from src.application.operation.GetDataOperationList.GetDataOperationListMapping import GetDataOperationListMapping
...
from src.application.operation.GetDataOperationList.GetDataOperationListSpecifications import \
