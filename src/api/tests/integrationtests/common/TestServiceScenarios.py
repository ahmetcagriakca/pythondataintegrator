...
# from pdi.domain.aps import ApSchedulerJob
...
# from pdi.domain.operation import DataOperation, DataOperationJob, DataOperationJobExecution
# from pdi.domain.secret import Secret
...
#                 return data_operation_job_execution
#
#     def create_data_operation(self, data_operation, connection_databases=None, connection_files=None,
