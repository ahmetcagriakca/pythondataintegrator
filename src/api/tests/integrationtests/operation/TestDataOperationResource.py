...
#         expected = True
#         self.test_manager.service_scenarios.create_test_connection_database(
#             TestDataOperationDatabaseData.test_integration_connection)
#         try:
...
#                TestDataOperationDatabaseData.test_insert_input_same_integration_1['Integrations'][0]["Integration"][
#                    "Code"]
#         assert data_operation.Integrations[0].DataIntegration.Code == \
...
#         assert len(data_operation.Integrations) == 1
#         assert data_operation.Integrations[0].DataIntegration.Code == \
#                TestDataOperationDatabaseData.test_insert_input_same_integration_2['Integrations'][0]["Integration"][
#                    "Code"]
#         assert data_operation.Integrations[0].DataIntegration.Code == \
#                response_data['Result']['Integrations'][0]["Integration"]["Code"]
