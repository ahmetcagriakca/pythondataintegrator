...
class DataOperationModels:
    ...
    get_data_operations_parser: RequestParser = IocManager.api.parser()

    get_data_operations_parser.add_argument('PageNumber', type=int, location='args', help='Queried value')
