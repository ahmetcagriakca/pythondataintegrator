...
class DataOperationJobListSpecifications:
    @inject
    def __init__(self,
    ...
    def specify(self, data_query: Query, query: DataOperationJobListQuery) -> Query:
    ...
    def __specified_query(self, query: DataOperationJobListQuery, data_query: Query) -> Query:
    ...
    def count(self, query: DataOperationJobListQuery, data_query: Query) -> Query:
