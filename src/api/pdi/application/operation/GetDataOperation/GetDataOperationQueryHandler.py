...
from pdi.application.operation.GetDataOperation.GetDataOperationMapping import GetDataOperationMapping
...
from pdi.application.operation.GetDataOperation.GetDataOperationSpecifications import GetDataOperationSpecifications
