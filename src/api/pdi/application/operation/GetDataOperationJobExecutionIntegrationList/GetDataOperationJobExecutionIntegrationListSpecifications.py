...
from pdi.domain.integration import DataIntegrationConnection, DataIntegration
from pdi.domain.operation import DataOperationIntegration, DataOperationJobExecutionIntegration, \
