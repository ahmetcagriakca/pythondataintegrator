...
from pdi.application.integration.services.DataIntegrationConnectionService import DataIntegrationConnectionService
...
from pdi.domain.operation import Definition
