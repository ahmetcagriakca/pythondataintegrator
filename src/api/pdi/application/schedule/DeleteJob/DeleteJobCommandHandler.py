...
from pdi.application.schedule.DeleteJob.DeleteJobCommand import DeleteJobCommand
...
class DeleteJobCommandHandler(ICommandHandler[DeleteJobCommand]):
    ...
    def handle(self, command: DeleteJobCommand):
        ...
        self.notify(message=f'{data_operation_job.DataOperation.Name} operation, job {data_operation_job.Id} removed',
