...
from pdi.application.connection.services.ConnectionServerService import ConnectionServerService
from pdi.application.connection.services.ConnectionTypeService import ConnectionTypeService
