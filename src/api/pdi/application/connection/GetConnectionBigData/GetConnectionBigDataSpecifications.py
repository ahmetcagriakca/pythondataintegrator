...
from pdi.domain.connection import ConnectionType, ConnectorType, Connection, ConnectionServer, \
    ConnectionBigData, ConnectionSecret
from pdi.domain.secret import Secret, SecretSource, AuthenticationType, SecretSourceBasicAuthentication, \
