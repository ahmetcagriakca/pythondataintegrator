...
from pdi.application.connection.LookupConnection.LookupConnectionMapping import LookupConnectionMapping
from pdi.application.connection.LookupConnection.LookupConnectionQuery import LookupConnectionQuery
from pdi.application.connection.LookupConnection.LookupConnectionResponse import LookupConnectionResponse
from pdi.application.connection.LookupConnection.LookupConnectionSpecifications import LookupConnectionSpecifications
