...
from pdi.domain.connection import ConnectionDatabase, Connection
from pdi.domain.integration import DataIntegrationConnection
from pdi.domain.operation import DataOperationIntegration
