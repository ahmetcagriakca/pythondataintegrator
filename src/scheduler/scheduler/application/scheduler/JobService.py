...
from scheduler.rpc.ProcessRpcClientService import ProcessRpcClientService
from scheduler.application.operation.commands.CreateExecutionCommand import CreateExecutionCommand
from scheduler.application.operation.commands.SendSchedulerErrorMailCommand import SendSchedulerErrorMailCommand
...
class JobService:
    ...
    def start_data_operation(self, job_id, data_operation_id: int):
        ...
        try:
            ...
            DependencyContainer.Instance.get(ProcessRpcClientService).call_job_start(data_operation_id=data_operation_id,
                                                                            job_id=job_id,
