...
from scheduler.domain.dao.secret.Secret import Secret
from scheduler.domain.dao.secret.AuthenticationType import AuthenticationType


class SecretType(Entity, DependencyContainer.Base):
