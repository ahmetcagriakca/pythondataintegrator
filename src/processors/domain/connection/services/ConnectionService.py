...
class ConnectionService(IScoped):
    ...
    def create_connection_database(self, model: ConnectionDatabase) -> Connection:
        """
    ...
    def create_connection_file(self, model: ConnectionFile) -> Connection:
        """
        Create File connection
        """
    ...
    def create_connection_queue(self, model: ConnectionQueue) -> Connection:
        """
        Create File connection
        """
