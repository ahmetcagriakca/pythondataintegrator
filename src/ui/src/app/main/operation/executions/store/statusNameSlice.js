...
export const getStatusName = createAsyncThunk('dataOperationJobExecutionsApp/statusName/getStatusName', async params => {
...
export const { selectAll: selectStatusName, selectById: selectStatusNameById } = statusNameAdapter.getSelectors(
	state => state.dataOperationJobExecutionsApp.statusName
);

const statusNameSlice = createSlice({
	name: 'dataOperationJobExecutionsApp/statusName',
