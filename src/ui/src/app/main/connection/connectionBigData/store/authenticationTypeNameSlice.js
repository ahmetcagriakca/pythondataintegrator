...
export const getAuthenticationTypeName = createAsyncThunk('connectionBigDataApp/authenticationTypeName/getAuthenticationTypeName', async (params, extra) => {
	try {
...
export const { selectAll: selectAuthenticationTypeName, selectById: selectAuthenticationTypeNameById } = authenticationTypeNameAdapter.getSelectors(
	state => state.connectionBigDataApp.authenticationTypeName
);

const authenticationTypeName = createSlice({
	name: 'connectionBigDataApp/authenticationTypeName',
