...
class ExecuteIntegrationUnpredictedSourceAdapter(ExecuteAdapter, IScoped):
    ...
    def get_finish_log(self, data_integration_id: int, data_count: int):
        ...
        if target_connection.Database is not None:
            ...
            log = f"{target_connection.File.FileName} integration execute operation finished. (Source Data Count:{data_count})"
        elif target_connection.Queue is not None:
    ...
    def get_error_log(self, data_integration_id: int):
        ...
        if target_connection.Database is not None:
            ...
            log = f"{target_connection.File.FileName} integration execute operation getting error"
        elif target_connection.Queue is not None:
